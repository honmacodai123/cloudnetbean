...
<!-- //for bootstrap working -->
<link href='font/css1.css' rel='stylesheet' type='text/css'>
				...
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
							<div class="agile_ecommerce_tabs"> <!-- bắt đầu từ đây -->
								<?php foreach ($products as $key => $value): ?>
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<!-- Edit Products-->
										<img src="admin_shop/admin_system/images/products/<?php echo $value['image'] ?>" alt="" class="pro-image-front">
										<img src="admin_shop/admin_system/images/products/<?php echo $value['image'] ?>" alt="" class="pro-image-back">
									...
									<h5><a href="single.php?productid=<?php echo $value['productid']?>"><?php echo $value['productname'] ?></a></h5>
									<div class="simpleCart_shelfItem">
										<p><span>$320</span> <i class="item_price"><?php echo '$'.$value['price']; ?></i></p>
										<p><a class="item_add" href="#">Add to cart</a></p>
									</div>
								</div>
								<?php endforeach; ?>
								<!-- Edit Products Shin Kết thúc tại đây -->
							</div>
						</div>
